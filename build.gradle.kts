...
dependencies {
    ...
    intellijPlatform {
        ...
        // JSON PSI to read the pasted/selected JSON structure, Java+Kotlin
        // to generate into either language (same combination already
        // proven together in json-schema-companion + bean-copy-companion).
